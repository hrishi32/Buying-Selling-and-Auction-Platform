...
$sql="SELECT object.id, object.title, object.price , object.description,object.user,object.available,object.image1_src,object.owner FROM object INNER JOIN user_order on object.id=user_order.item_id and user_order.user_id = $usrid";
// echo $sql;
$result = mysqli_query($db,$sql);
