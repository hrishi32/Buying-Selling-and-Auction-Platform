...
if(!$result)
{
	...
	// echo "usr id is ".$usrid;

$sql="SELECT share.id, share.title, share.price , share.description,share.user,share.available,share.image1_src,share.owner FROM share INNER JOIN proposals on share.id=proposals.item_id and proposals.user_id = $usrid";
// echo $sql;
$result = mysqli_query($db,$sql);
