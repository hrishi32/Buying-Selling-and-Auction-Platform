		...
		<div id="container">
          ...
          <div id="bhavesh" style="padding:80px; text-align:left;">
              ...
              <div id="button_choose" style="margin-top:80px;"><pre  style="display:inline;">            </pre>
                ...
                <div id="auction" onclick="auction_form();">Auction</div>
              </div>
          ...
          var auction = 0;
            ...
            function  sell_form(){
                if(p==0){
                    ...
                    document.getElementById('bhavesh4').innerHTML = "<pre style='display:inline'>        </pre>"+"  "+"Want To sell";
                    ...
                    document.getElementById('what_opt_for').value ="sell";
                    sold = 1;
                    p=1;
                }  
            }
            ...
            function auction_form(){
                 if(p==0){
                    document.getElementById('button_choose').style.display ="none";
                    document.getElementById('button_choose').style.display ="none";
                    var div_input1 = document.createElement('div');
                    document.getElementById('bhavesh4').appendChild(div_input1);
                    div_input1.innerHTML = "Base Price "+"<pre style='display:inline;'>        </pre>";
                    div_input1.className ="form_divs";
                    var input1 = document.createElement('input');
                    div_input1.appendChild(input1);
                    input1.name = "bprice";
                    ...
                    var div_input2 = document.createElement('div');
                    document.getElementById('bhavesh4').appendChild(div_input2);
                    div_input2.innerHTML = "Buy Now Price"+"<pre style='display:inline;'>    </pre>";
                    div_input2.className ="form_divs";
                    var input2 = document.createElement('input');
                    div_input2.appendChild(input2);
                    input2.name = "bnprice";
                    ...
                    var div_input3 = document.createElement('div');
                    document.getElementById('bhavesh4').appendChild(div_input3);
                    div_input3.innerHTML = "<pre style='display:inline;'>           </pre>"+ "Start Time"+"<pre style='display:inline;'>        </pre>";
                    div_input3.className ="";
                    var input3 = document.createElement('input');
                    div_input3.appendChild(input3);
                    input3.name = "startd";
                    input3.type  =  "date";   
                    var input4 = document.createElement('input');
                    div_input3.appendChild(input4);
                    input4.name = "startt";
                    input4.type  =  "time";  
                    div_input3.style.marginBottom ="20px";
                    div_input3.style.marginTop = "20px";
                    var div_input4 = document.createElement('div');
                    document.getElementById('bhavesh4').appendChild(div_input4);
                    div_input4.innerHTML = "<pre style='display:inline;'>           </pre>"+ "Start Time"+"<pre style='display:inline;'>        </pre>";
                    div_input4.className ="";
                    var input5 = document.createElement('input');
                    div_input4.appendChild(input5);
                    input5.name = "endd";
                    input5.type  =  "date";   
                    var input6 = document.createElement('input');
                    div_input4.appendChild(input6);
                    input6.name = "endt";
                    input6.type  =  "time";             
                    
                    document.getElementById('what_opt_for').value ="auction";          
                    auction  = 1;
