...
$sql="SELECT object.id, object.price , object.description,object.user,object.owner,object.available,object.image1_src FROM object INNER JOIN user_cart on object.id=user_cart.item_id and user_cart.user_id = $usrid";
// echo $sql;
$result = mysqli_query($db,$sql);
...
if(!$row)
{
	...
	<?php 
		...
		echo "<a href=\"index.php\"><button type=button  >Go shopping</button></a>";
		} ?>
