...
--
-- Host: localhost
-- Generation Time: Nov 11, 2017 at 08:29 PM
...
(1, 'hoomanlovescat@gmail.com', 'bike', 'MTB', 'cycle', 'a beautiful mtb with front suspensions and 27 speed system', 12999, 0),
(2, 'hoomanlovesdog@gmail.com', 'pendrive', 'usb', '16gb', 'toshiba', 99, 0),
...
(5, 'aruyani@ymail.com', 'love necklace', 'pendant', 'piece', 'Silver jewel', 1540, 0),
(6, 'pandai@ymail.com', 'lays', 'chips', 'food', 'lays', 20, 1),
...
INSERT INTO `user_order` (`user_id`, `item_id`) VALUES
(0, 0),
(2, 1),
(2, 2),
(2, 3),
